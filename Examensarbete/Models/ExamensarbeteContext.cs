...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=localhost; Database=Examensarbete ;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasOne(d => d.AnswerContent)
                    .WithMany(p => p.QuestionAnswerContent)
                    .HasForeignKey(d => d.AnswerContentId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Question_Content2");

                entity.HasOne(d => d.BodyContent)
                    .WithMany(p => p.QuestionBodyContent)
                    .HasForeignKey(d => d.BodyContentId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Question_Content1");

                entity.HasOne(d => d.HeaderContent)
                    .WithMany(p => p.QuestionHeaderContent)
                    .HasForeignKey(d => d.HeaderContentId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<Test>(entity =>
            {
                entity.HasOne(d => d.HeaderContent)
                    ...
                    .HasForeignKey(d => d.HeaderContentId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Test_Content");
            });
